/**
 * commands/downloads/play.js — busca com botões funcionais (!play / !ytsearch).
 *
 * Fluxo: busca → lista + botões [🎵 Áudio] [🎬 Vídeo] [🔗 Abrir] por resultado.
 */
...
module.exports = [
  {
    ...
    commands: ['play'],
    category: 'downloads',
    description: 'Busca músicas/vídeos no YouTube e mostra botões para baixar.',
