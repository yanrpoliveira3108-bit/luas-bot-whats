...
async function connect({ phone } = {}) {
  ...
  try {
    ...
    //    O fork @innovatorssoft/baileys usa fetch (RequestInit); o timeout
    //    é passado via AbortSignal. A função NUNCA lança: em falha, retorna
    //    a versão embutida com isLatest=false (o handshake exige version).
