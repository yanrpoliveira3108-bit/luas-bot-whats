...
const SYNONYMS = {
  ...
  jogar: ['tigrinho', 'cacatesouro', 'quiz', 'batalha', 'luck', 'jokenpo', 'expedicao'],
  jogo: ['tigrinho', 'cacatesouro', 'quiz', 'batalha', 'luck', 'jokenpo', 'expedicao'],
  grana: ['carteira', 'saldo', 'banco', 'pix', 'trabalhar', 'daily', 'extrato', 'feira'],
  dinheiro: ['carteira', 'saldo', 'banco', 'pix', 'trabalhar', 'daily', 'extrato', 'feira'],
  mercado: ['feira', 'comprar', 'vender', 'loja'],
  comprar: ['feira', 'loja'],
  vender: ['feira', 'loja'],
  ajuda: ['ajuda', 'help', 'guia', 'tutorial'],
  tutorial: ['guia', 'tutorial', 'ajuda'],
  aventura: ['expedicao', 'aventura'],
  item: ['inventario', 'feira', 'colecoes', 'vitrine', 'loja'],
  itens: ['inventario', 'feira', 'colecoes', 'vitrine', 'loja'],
  colecao: ['colecoes', 'vitrine'],
  colecoes: ['colecoes', 'vitrine'],
};
