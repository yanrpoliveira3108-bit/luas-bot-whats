...
nav.registerScreen('lua_automod', () => ({
  ...
  buttons: [
    ...
    { id: 'antipix', text: '💸 Anti-pix/pagamento', run: run('antipix') },
    { id: 'antilocalizacao', text: '📍 Anti-localização', run: run('antilocalizacao') },
    { id: 'anticontato', text: '👤 Anti-contato', run: run('anticontato') },
  ],
}));
